...
class Collection:
    def __init__(self, id) -> None:
        r = requests.post("https://api.steampowered.com/ISteamRemoteStorage/GetCollectionDetails/v1/", data = {"collectioncount": 1, "publishedfileids[0]": id})
        ...
        r = requests.post("https://api.steampowered.com/ISteamRemoteStorage/GetPublishedFileDetails/v1/", data = requestBody)
